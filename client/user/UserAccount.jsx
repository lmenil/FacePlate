...
import { Card, CardContent, Typography, TextField, Button, Box, CircularProgress, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
...
const UserAccount = () => {
  ...
  const [updateData, setUpdateData] = useState({ name: '', email: '', password: '', confirmPassword: '' }); // State for update form
